    ...
    <nav>
      <div class="capsule">
        <nuxt-link exact to="/">
          <svg class="logo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" aria-labelledby="shopicon" role="presentation" width="60" height="60">
            ...
            <g fill="black">
              ...
              <path d="M52.74 50H30.8a1 1 0 0 0-1 1v14.59a1 1 0 0 0 1 1h21.94a1 1 0 0 0 1-1V51a1 1 0 0 0-1-1zm-1 14.63H31.8V52h19.94zM60.08 62.94h5.44a1 1 0 0 0 1-1v-2.75a1 1 0 0 0-1-1h-5.44a1 1 0 0 0-1 1v2.74a1 1 0 0 0 1 1.01zm1-2.74h3.44v.74h-3.44z"></path>
            </g>
          </svg>
        </nuxt-link>
        <ul>
        ...
        <div>
          ...
          <div id="user"></div>
          <span v-show="true" @click="showModal = true">Login</span>
          <span v-show="false">Welcome, User!</span>
